  ...
  return (
    <section className="py-16 md:py-24 bg-white" id="for-providers">
      <div className="container mx-auto px-4 max-w-5xl">
        {/* REALITY SECTION */}
        <Card className="relative bg-gradient-to-br from-secondary via-white to-white border-0 shadow-xl px-8 py-8 mb-20 hover:shadow-2xl transition-shadow duration-300">
        ...
        <div className="text-center mb-20 max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            {BRIDGE_BENEFITS.map((b, idx) => (
              <div key={idx} className="flex gap-4 items-start bg-secondary rounded-lg shadow p-5 border hover:shadow-md transition-shadow duration-300 h-full">
                <div className="mt-1 flex-shrink-0">{b.icon}</div>
                <div>
        ...
        <div className="flex flex-col md:flex-row-reverse gap-12 items-center">
          <div className="md:w-1/2">
            <div className="bg-secondary rounded-lg shadow-xl p-8 h-full flex flex-col justify-between hover:shadow-2xl transition-shadow duration-300">
