...
const SocialAuthButtons = ({ 
  handleOAuth, 
  loading,
  loadingProviders = { google: false, github: false, twitter: false }
  ...
  return (
    <div className="space-y-2">
      <Button 
        ...
        type="button" 
        disabled={loading || loadingProviders.google}
      >
      ...
      <Button 
        ...
        type="button" 
        disabled={loading || loadingProviders.github}
      >
      ...
      <Button 
        ...
        type="button" 
        disabled={loading || loadingProviders.twitter}
      >
